...
if (empty($data["user_id"])) {
   // This means the user has not approved the app and has somehow found his way to the Canvas URL.
   exit;
    ...
    if ($user) {
      try {
        $facebook_data = $facebook->api('/me?scope=email');
...
<html>
    <head>
        <title>ReNotifier Demo - Canvas</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <p class="text-center">Woo-hoo <?=$facebook_data['first_name']?>! You authorized and connected to our Demo Facebook app! This means:</p>
        </div>
        ...
        <br>
        <p>1. We captured the following information from your Facebook profile:</p>
        ...
        <br>
        <p>2. We added you to ReNotifier and already sent you an Autoresponder notification :) <a href="https://www.facebook.com">Check your Facebook >></a></p>
...
<p>P.S.3: Accept Rate for Facebook Login Dialogs is 60% to up to 90%, depending on how good your value proposition is. This means that out of every 100 people who see Facebook Login Dialog, 60 to 90 of them will authorize and connect to your Facebook app!</p>
